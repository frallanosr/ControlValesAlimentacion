                                ...
                                <div style="align-items: center">
                                    ...
                                    <table align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input onclick="clave('0', 'campo');" type="button" value="0" name="0" id="boton" style="height: 60px; width: 60px ; margin:2px;"></td>
                                            <td>
                                                <input type="reset" value="DEL" name="DEL" id="boton" style="height: 60px; width: 60px ; margin:2px;"></td>
